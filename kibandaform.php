...
<!------------content goes here------------>
	<h5 align="left">Ongeza Kibanda</h5>
<form method="post" action="addkibanda.php">
<table cellpadding="12px" >
	<tr>
		<td>Enter name:</td> <td><input type="text" name="txtname" value="" required=""  class="form-control"></td>
	</tr>
	<tr>
		<td>Date:</td> <td><input type="date" name="txtdate" value="" required="" class="form-control"></td>
	</tr>
	<tr>
		<td colspan="2" align="right"><button type="submit" class="btn btn-success">Register new Kibanda</button></td>
	</tr>
