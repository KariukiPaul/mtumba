...
$counter = 0;
$sql = "SELECT * FROM `kibanda` WHERE (id='$id' && uid='$uid' && status='active')";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "
 <form method=post action=updatekibanda.php>
<table cellpadding='12px' >
	<tr>
		<td>Kibanda name:</td> <td><input type=text name=txtname value='".$row["name"]."' required  class='form-control'></td>
	</tr>
	<tr>
