...
$counter = 0;
$sql = "SELECT * FROM `sales` where (id='$id' && uid='$uid' && kid='$kid' && status='active')";
...
<table cellpadding='12px' >
	...
	<tr>
		<td>Quantity:</td> <td><input type=text name=txtquantity value='".$row["quantity"]."' required  class='form-control'></td>
	</tr>
	<tr>
		<td>
